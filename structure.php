...
function renderHeader($conn)
{
    ...
    echo '<a href="successshow.php" class="btn1" style="margin-left:1rem;"><i class="fa-solid fa-receipt"></i></i></a>'; // Cart icon
    echo '<a href="cart.php" class="btn1" style="margin-left:1rem;margin-right:1.4rem;"><i class="fa-solid fa-bag-shopping"></i></i></a>';
