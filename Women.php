...
<body>
    ...
    <!-- billbord -->
    <div class="billboard">
        <img src="myfile\runf.jpg" alt="Banner Image">
    </div>
    ...
    <body>
        ...
        <div class="container mt-5 card_contain">
            <h2 class="text-start">สินค้าล่าสุด สำหรับผู้หญิง</h2>
        ...
        <!-- Hero Section -->
        <div class="container mt-5" style="background-color: #f4f4f4; height: 800px;;">WOMEN</div>
        <section class="hero">
        ...
        <div class="container mt-5 card_contain">
            <h2 class="text-start">สินค้ายอดนิยม สำหรับผู้หญิง</h2>
            <div class="row flex-nowrap overflow-auto" style="white-space: nowrap;">
