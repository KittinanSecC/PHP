document.addEventListener("DOMContentLoaded", function () {
    ...
    const updateCart = (cartId, currentQuantity, cartItem, subtotalElement, totalElement, button) => {
    ...
    document.querySelectorAll(".qty-btn").forEach((button) => {
        button.addEventListener("click", function () {
            ...
            updateCart(cartId, currentQuantity, cartItem, subtotalElement, totalElement, this);
        });
    });
